...
# 将保存路径设置为脚本文件所在的同一目录
model_save_path = os.path.join(script_dir, f'{train_base_name}_GRU.pth')
prediction_save_path = os.path.join(script_dir, f'{train_base_name}X_GRU.csv')
scaler_save_path_X = os.path.join(script_dir, f'{train_base_name}_GRU_scaler_X.gz')
scaler_save_path_y = os.path.join(script_dir, f'{train_base_name}_GRU_scaler_y.gz')
