...
INPUT_PATH = ['..\SinData\Trace',num2str(DATA_ROWS),'.txt'];
OUTPUT_PATH = 'EstimationResult\Data_5';
...
% Output Results
fullOutputFilePath = fullfile('EstimationResult\Data_5\EstimationResult_.txt');
