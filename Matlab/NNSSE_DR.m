...
INPUT_PATH = ['..\DRData\Trace',num2str(DATA_ROWS),'.txt'];
...
% Output Results
fullOutputFilePath = fullfile('EstimationResult\Data_1\EstimationResult_.txt');
...
fullOutputFilePath = fullfile('EstimationResult\Data_2\EstimationResult_.txt');
fileID = fopen(fullOutputFilePath, 'w');
if fileID == -1
    error('Unable to create file: %s', fullOutputFilePath);
end
...
AccumationStart = 200;
PathTemp1= 'EstimationResult\Data_1';
