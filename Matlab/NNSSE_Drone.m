...
INPUT_PATH = ['..\DroneData\Trace',num2str(DATA_ROWS),'.txt'];
...
% Output Results
fullOutputFilePath = fullfile('EstimationResult\Data_3\EstimationResult_.txt');
...
fullOutputFilePath = fullfile('EstimationResult\Data_4\EstimationResult_.txt');
fileID = fopen(fullOutputFilePath, 'w');
if fileID == -1
    error('Unable to create file: %s', fullOutputFilePath);
end
...
AccumationStart = 200;
PathTemp1= 'EstimationResult\Data_4';
